...
public class ModItems {
    ...
    public static final RegistryObject<Item> SHADOW_ROCK_AXE = ITEMS.register("shadow_rock_axe", () -> new AxeItem(ModToolTiers.SHADOW_ROCK,4, 1, new Item.Properties().durability(2000)));
    ...
    public static final RegistryObject<Item> SHADOW_SPIRIT_SPAWN_EGG = ITEMS.register("shadow_spirit_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.SHADOW_SPIRIT, 0x7e9680, 0xc5d1c5, new Item.Properties()));
